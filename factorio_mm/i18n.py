...
STRINGS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "menu_exit": "Exit",
        "prompt_choice": "Your choice [1-12, L, q]: ",
        "goodbye": "Goodbye!",
        ...
        "prompt_remove_select": "Select mod numbers/names to remove (e.g. 1 3-5 or 'all') [q to cancel]: ",
    ...
    "ru": {
        ...
        "menu_lang": "Switch language / Сменить язык",
        "menu_exit": "Выход",
        "prompt_choice": "Ваш выбор [1-12, L, q]: ",
        "goodbye": "До свидания!",
        ...
        "prompt_remove_select": "Выберите номера/имена модов для удаления (например 1 3-5 или 'all') [q для отмены]: ",
