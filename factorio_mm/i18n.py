...
STRINGS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "prompt_profile_name": "Enter profile number (1-{max}) to switch, or 'd <num>' to delete [q to cancel]: ",
        "prompt_delete_profile_target": "Enter profile number or name to delete [q to cancel]: ",
        "prompt_confirm_delete_profile": "Are you sure you want to delete profile '{name}'? [y/N]: ",
    ...
    "ru": {
        ...
        "prompt_profile_name": "Введите номер профиля (1-{max}) для переключения или 'd <номер>' для удаления [q для отмены]: ",
        "prompt_delete_profile_target": "Введите номер или имя профиля для удаления [q для отмены]: ",
        "prompt_confirm_delete_profile": "Вы уверены, что хотите удалить профиль '{name}'? [y/N]: ",
