...
public final class LocalizationManager: ObservableObject, @unchecked Sendable {
    ...
    private static let strings: [AppLanguage: [String: String]] = [
        .en: [
            ...
            "resolving_dependencies_title": "Resolving Dependencies",
            "resolving_dependencies_count": "Analyzing dependencies for %d mod(s)...",
            "resolving_mod": "Checking",
            "browse_author_tooltip": "Browse mods by %@",
            ...
            "description_tab": "Description (D)",
            "changelog_tab": "Changelog (C)",
            "releases_tab": "Releases (R)",
            "tab_shortcut_desc": "d",
            "tab_shortcut_change": "c",
            "tab_shortcut_rel": "r",
        ...
        .ru: [
            ...
            "resolving_dependencies_title": "Разрешение зависимостей",
            "resolving_dependencies_count": "Анализ зависимостей для %d мод(ов)...",
            "resolving_mod": "Проверка",
            "browse_author_tooltip": "Смотреть моды от %@",
            ...
            "description_tab": "Описание (О)",
            "changelog_tab": "Ченджлог (Ч)",
            "releases_tab": "Релизы (Р)",
            "tab_shortcut_desc": "о",
            "tab_shortcut_change": "ч",
            "tab_shortcut_rel": "р",
